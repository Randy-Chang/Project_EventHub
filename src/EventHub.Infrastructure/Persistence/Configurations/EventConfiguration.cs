...
internal sealed class EventConfiguration : IEntityTypeConfiguration<DomainEvent>
{
    public void Configure(EntityTypeBuilder<DomainEvent> builder)
    {
        ...
        builder.Property(eventItem => eventItem.JoinCode)
            .HasMaxLength(EventJoinCode.Length)
            .UseCollation("NOCASE")
            .IsRequired();
        ...
        builder.Property(eventItem => eventItem.DisplayMode).HasConversion<string>().HasMaxLength(30).IsRequired();
        ...
        builder.HasIndex(eventItem => eventItem.JoinCode).IsUnique();
